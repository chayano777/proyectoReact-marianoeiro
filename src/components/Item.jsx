    ...
    <div className="flex p-4 border rounded-lg shadow-lg">
      ...
      <div className="mt-2">
        ...
        <div className="flex flex-col w-3/4 px-10 py-4 align-bottom">
          ...
          <button className="mt-5 px-3 py-2 border border-orange-400 rounded-lg text-md font-medium 
                  text-slate-800 bg-orange-200 hover:bg-stone-300 hover:border-stone-300">Agregar</button>
        </div>
      </div>
    </div>
  );
